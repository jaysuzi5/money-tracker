...
urlpatterns = [
    ...
    path('scheduled/post/', views.scheduled_post, name='scheduled_post'),
    path('duplicates/', views.duplicates, name='duplicates'),
    path('duplicates/delete/', views.duplicate_delete, name='duplicate_delete'),
    path('matches/', views.matches, name='matches'),
    path('matches/confirm/', views.match_confirm, name='match_confirm'),
    path('matches/dismiss/', views.match_dismiss, name='match_dismiss'),
